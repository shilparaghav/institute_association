module.exports = class CommonController {
    ...
    check_inputs( in_data_obj, in_required ) {
        ...
        var check_required = in_required != undefined ? true: false;
...
// var con = new CommonController( config );

// console.log(con);

// console.log( con.check_inputs( in_data, true ) );
// console.log( con.check_inputs( in_data ) );